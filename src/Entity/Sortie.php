...
class Sortie
{
    ...
    /**
    * @ORM\ManyToOne(targetEntity="App\Entity\Bateau")
    ...
    */
     ...
     * Set bateau
     *
     * @param \App\Entity\Bateau $bateau
     *
     * @return Sortie
     */
    public function setBateau(\App\Entity\Bateau $bateau)
    {
        $this->bateau = $bateau;
     ...
     * Add athlete
     *
     * @param \App\Entity\User $athlete
     *
     * @return Sortie
     */
    public function addAthlete(\App\Entity\User $athlete)
    {
     ...
     * @param \App\Entity\User $athlete
     */
    public function removeAthlete(\App\Entity\User $athlete)
    {
