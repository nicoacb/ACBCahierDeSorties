...
class Bateau
{
    ...
    /**
    * @ORM\ManyToOne(targetEntity="App\Entity\TypeBateau", cascade={"persist"})
    ...
    */
     ...
     * Set type
     *
     * @param \App\Entity\TypeBateau $type
     *
     * @return Bateau
     */
    public function setType(\App\Entity\TypeBateau $type)
    {
        $this->type = $type;
